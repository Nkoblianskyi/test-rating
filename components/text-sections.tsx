export function TextSections() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      ...
      <section>
        <h2 className="text-3xl font-bold text-white mb-8 text-center bg-black bg-opacity-70 py-2 rounded-lg">
          How We Select the Best Irish Betting Sites
        </h2>
        <div className="prose prose-lg max-w-none bg-black bg-opacity-70 p-6 rounded-lg text-white">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">Licensing & Security</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">Odds & Market Variety</h3>
              <p className="text-gray-200 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">Bonuses & Promotions</h3>
              <p className="text-gray-200 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">Responsible Gambling</h3>
              <p className="text-gray-200 mb-6">
      ...
      <section>
        <h2 className="text-3xl font-bold text-white mb-8 text-center bg-black bg-opacity-70 py-2 rounded-lg">
          Tips for Safer Betting in Ireland
        </h2>
        <div className="prose prose-lg max-w-none bg-black bg-opacity-70 p-6 rounded-lg text-white">
          <p className="text-gray-200 mb-6">
