...
export function Sidebar() {
  ...
  return (
    <div className="lg:sticky lg:top-24">
      <div className="bg-white border-2 border-[#FFD700] rounded-lg p-6 shadow-lg">
        <div className="text-center mb-4">
          <h3 className="text-lg font-bold text-[#003B2F] mb-2">🏆 Featured Site</h3>
        </div>
        ...
        <div className="text-center mb-4">
          ...
          />
          <h4 className="text-xl font-bold text-[#333333] mb-2">{randomSite.name}</h4>
          ...
          <div className="flex items-center justify-center mb-3">
            ...
            <span className="ml-2 font-semibold text-[#333333]">{randomSite.rating}</span>
          </div>
        </div>

        <div className="bg-[#003B2F] text-white p-4 rounded-lg mb-4">
        ...
        <p className="text-xs text-gray-500 text-center">{randomSite.disclaimer}</p>
      </div>
    </div>
  )
}
